...
java -Dderby.system.home=$HOME/.webdav_sync/ -Dbe.re.http.no-compress -jar $HOME/.webdav_sync/webdav_sync1_1_6.jar -r -bi -u http://$user:$pass@$host:$port/remote.php/dav/files/swint/Downloads/ -d $HOME/Downloads/
