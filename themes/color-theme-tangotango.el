...
(defun color-theme-tangotango ()
  ...
  (color-theme-install
   '(color-theme-tangotango
     ...
     (org-level-1 ((t (:bold nil :foreground "dodger blue" :height 1.20))))
     (org-level-2 ((t (:bold nil :foreground "#edd400" :height 1.15))))
     (org-level-3 ((t (:bold nil :foreground "#6ac214" :height 1.10))))
