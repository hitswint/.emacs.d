(custom-set-variables
 ...
 (quote
  (helm helm-core ztree zotelo youdao-dictionary wrap-region window-numbering which-key web-mode w3m w32-browser volatile-highlights vlf visual-regexp visible-mark vimish-fold use-package undo-tree tangotango-theme smex smartrep smart-mode-line session recentf-ext readline-complete rainbow-mode rainbow-delimiters quickrun pyim popup-kill-ring pinyin-search persp-projectile peep-dired paredit-everywhere outline-magic operate-on-number nyan-mode neotree navi-mode multiple-cursors multifiles mingus mew matlab-mode markdown-mode magit magic-latex-buffer latex-preview-pane lacarte ivy-hydra interleave imenu-anywhere ido-vertical-mode ido-hacks ido-completing-read+ ido-at-point hungry-delete highlight-symbol highlight-parentheses helm-unicode helm-swoop helm-projectile helm-gtags helm-flyspell helm-flycheck helm-firefox helm-descbinds helm-bm helm-bibtex helm-ag graphviz-dot-mode goto-chg google-translate god-mode gnuplot-mode git-timemachine function-args flycheck-pos-tip flx-ido firefox-controller expand-region evil-nerd-commenter eshell-prompt-extras emms emmet-mode elpy elmacro elisp-slime-nav ein easy-kill dumb-jump drag-stuff disaster diredful dired-ranger dired-narrow dired-details diff-hl counsel company-web company-try-hard company-quickhelp company-c-headers clipmon clean-aindent-mode cdlatex buttercup bing-dict bbyac backup-walker avy-zap auto-highlight-symbol auto-complete-clang auto-complete-c-headers auto-complete-auctex auctex-latexmk arduino-mode anzu anchored-transpose aggressive-indent ace-pinyin ace-link ace-jump-mode ac-math ac-ispell ac-html-bootstrap)))
