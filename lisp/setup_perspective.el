...
(defun swint-save-perspectives ()
  ...
  (setq window-configuration-of-persp-8 (window-state-get nil t))
  (swint-persp-switch "9")
  (setq window-configuration-of-persp-9 (window-state-get nil t))
  (swint-persp-switch "0")
  (setq window-configuration-of-persp-0 (window-state-get nil t))
  (with-temp-file
      swint-perspectives-saved-file
    (when is-win
      (insert ";;; -*- coding: utf-8; -*-\n"))
    (insert "(setq " "persp-last-session ")
    (insert (prin1-to-string persp-last-session))
    (insert ")\n")
    ...
    (insert ")\n")
    (insert "(setq " "window-configuration-of-persp-8 '")
    (insert (prin1-to-string window-configuration-of-persp-8))
    (insert ")\n")
    ...
    (insert ")\n")
    (insert "(setq " "window-configuration-of-persp-9 '")
    (insert (prin1-to-string window-configuration-of-persp-9))
    (insert ")\n")
    ...
    (insert ")\n")
    (insert "(setq " "window-configuration-of-persp-0 '")
    (insert (prin1-to-string window-configuration-of-persp-0))
    (insert ")\n")))
...
(defun swint-perspective-init ()
  ...
  (senny-persp "8")
  (persp-reactivate-buffers (mapcar 'get-buffer buffers-in-perspectives-8))
  (window-state-put window-configuration-of-persp-8 nil t)
  (senny-persp "9")
  (persp-reactivate-buffers (mapcar 'get-buffer buffers-in-perspectives-9))
  (window-state-put window-configuration-of-persp-9 nil t)
  (senny-persp "0")
  (persp-reactivate-buffers (mapcar 'get-buffer buffers-in-perspectives-0))
  (window-state-put window-configuration-of-persp-0 nil t)
  (persp-switch "i")
