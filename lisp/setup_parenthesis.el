...
(use-package paredit
  ...
  (define-key paredit-mode-map (kbd "M-g _") 'paredit-forward-barf-sexp)
  (define-key paredit-mode-map (kbd "M-g (") 'paredit-wrap-round)
  (define-key paredit-mode-map (kbd "M-g )") 'paredit-wrap-round-from-behind)
  (define-key paredit-mode-map (kbd "M-g [") 'paredit-wrap-square)
  (define-key paredit-mode-map (kbd "M-g ]") 'paredit-wrap-square-from-behind)
  (define-key paredit-mode-map (kbd "M-g {") 'paredit-wrap-curly)
  (define-key paredit-mode-map (kbd "M-g }") 'paredit-wrap-curly-from-behind)
  (define-key paredit-mode-map (kbd "M-g <") 'paredit-wrap-angled)
  (define-key paredit-mode-map (kbd "M-g >") 'paredit-wrap-angled-from-behind)
  (define-key paredit-mode-map (kbd "M-g '") 'paredit-meta-singlequote)
  (define-key paredit-mode-map (kbd "M-g \"") 'paredit-meta-doublequote)
...
(use-package paredit-everywhere
  ...
  (define-key paredit-everywhere-mode-map (kbd "M-g _") 'paredit-forward-barf-sexp)
  (define-key paredit-everywhere-mode-map (kbd "M-g (") 'paredit-wrap-round)
  (define-key paredit-everywhere-mode-map (kbd "M-g )") 'paredit-wrap-round-from-behind)
  (define-key paredit-everywhere-mode-map (kbd "M-g [") 'paredit-wrap-square)
  (define-key paredit-everywhere-mode-map (kbd "M-g ]") 'paredit-wrap-square-from-behind)
  (define-key paredit-everywhere-mode-map (kbd "M-g {") 'paredit-wrap-curly)
  (define-key paredit-everywhere-mode-map (kbd "M-g }") 'paredit-wrap-curly-from-behind)
  (define-key paredit-everywhere-mode-map (kbd "M-g <") 'paredit-wrap-angled)
  (define-key paredit-everywhere-mode-map (kbd "M-g >") 'paredit-wrap-angled-from-behind)
  (define-key paredit-everywhere-mode-map (kbd "M-g '") 'paredit-meta-singlequote)
  (define-key paredit-everywhere-mode-map (kbd "M-g \"") 'paredit-meta-doublequote)
