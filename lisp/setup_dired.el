...
(use-package image-dired
  ...
  (add-hook 'dired-mode-hook (lambda ()
                               (bind-key "C-M-i" #'(lambda () (interactive) (if (not (global-image-dired-minor-mode 'toggle))
  ...
  (bind-key "C-M-i" #'(lambda () (interactive) (global-image-dired-minor-mode -1) (swint-kill-buffer)) image-dired-thumbnail-mode-map)
