...
(use-package eaf
  ...
  (use-package eaf-pdf-viewer
    ...
    (defun eaf-pdf-search-with-text (&optional text)
      (let ((target_text (or text (read-string "Search Text: "))))
        (eaf-call-sync "execute_function_with_args" eaf--buffer-id "send_input_message" "Search Text: " "search_text" "search" target_text)))
    (defun eaf-pdf-search-text/around (fn)
      (if eaf-search-input-active-p
          (funcall fn)
        (eaf-pdf-search-with-text)))
