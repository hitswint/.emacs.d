(custom-set-variables
 ...
 (quote
  (sudo-edit youdao-dictionary ido-completing-read+ pyim pyim-basedict helm-pass pass helm-mu mu4e-alert ztree zotelo wrap-region window-numbering which-key web-mode w3m volatile-highlights vlf visual-regexp visible-mark vimish-fold use-package undo-tree tangotango-theme smex smartrep smart-mode-line skewer-mode session recentf-ext readline-complete rainbow-mode rainbow-delimiters quickrun popup-kill-ring pinyin-search persp-projectile peep-dired pdf-tools paredit-everywhere outline-magic operate-on-number nyan-mode neotree navi-mode names multiple-cursors multifiles matlab-mode markdown-mode magit magic-latex-buffer latex-preview-pane lacarte ivy-hydra interleave imenu-anywhere ido-vertical-mode ido-hacks ido-at-point hungry-delete highlight-symbol highlight-parentheses helm-unicode helm-swoop helm-projectile helm-gtags helm-flyspell helm-flycheck helm-firefox helm-descbinds helm-bm helm-bibtex helm-ag graphviz-dot-mode goto-chg google-translate god-mode gnuplot-mode git-timemachine function-args flycheck-ycmd flycheck-pos-tip flx-ido firefox-controller fcitx expand-region evil-nerd-commenter eshell-prompt-extras emms emmet-mode elpy elmacro elisp-slime-nav ein easy-kill dumb-jump drag-stuff disaster diredful dired-ranger dired-narrow dired-details diff-hl counsel company-ycmd company-web company-try-hard company-quickhelp company-c-headers clipmon clean-aindent-mode cdlatex buttercup bing-dict bbyac backup-walker avy-zap auto-highlight-symbol auto-complete-clang auto-complete-c-headers auto-complete-auctex auctex-latexmk arduino-mode anzu anchored-transpose aggressive-indent ace-pinyin ace-link ace-jump-mode ac-math ac-ispell ac-html-bootstrap)))
